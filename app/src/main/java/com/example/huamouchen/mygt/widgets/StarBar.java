...
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        this.starMark = mTypedArray.getFloat(R.styleable.StarBar_starIndex, 0f);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.StarBar_starEmpty);
        this.starFillDrawable = mTypedArray.getDrawable(R.styleable.StarBar_starFill);
    ...
    public void setStarMark(float mark){
        if (integerMark) {
            ...
            starMark = Math.round(mark * 1000) * 1.0f / 1000;
        }
...
//    }
    ...
    public void setStarSize(int starSize) {
        ...
        starFillBitmap = drawableToBitmap(starFillDrawable);
        paint = new Paint();
        paint.setAntiAlias(true);
        paint.setShader(new BitmapShader(starFillBitmap, BitmapShader.TileMode.CLAMP, BitmapShader.TileMode.CLAMP));
        invalidate();
