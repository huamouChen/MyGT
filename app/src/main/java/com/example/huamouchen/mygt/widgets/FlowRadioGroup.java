...
public class FlowRadioGroup extends PercentLinearLayout {
...
//        setCheckedId(id);
     ...
     * 
     * <p>
     * See {@link com.infox.pgreporting.R.styleable#PercentLayout_Layout LinearLayout
     * Attributes} for a list of all child view attributes that this class
     * supports.
     * </p>
     * 
     */
    public static class LayoutParams extends PercentLinearLayout.LayoutParams {
        /**
         * {@inheritDoc}
         */
